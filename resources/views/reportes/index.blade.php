<x-app-layout>
    ...
    <div class="sm:ml-64 p-6 pt-20">
        <div class="bg-white p-6 rounded-lg shadow">
          ...
          {{-- Formulario: sólo un input type="month" --}}
          <form action="{{ route('reportes.caducidad.pdf') }}" method="GET" class="mt-2 w-full">
            ...
            <button
              ...
              class="w-full inline-flex items-center justify-center
                     border-2 border-green-500 bg-transparent hover:bg-green-500
                     hover:text-white text-green-500 font-bold py-2 px-4 rounded transition"
            >
              <i class="fas fa-download mr-2"></i> Descargar PDF
            </button>
          </form>

    ...
    <div class="sm:ml-64 p-4 pt-20">
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div id="formAgregar" class="hidden mb-6">
                <form method="POST" action="{{ route('servicios.store') }}" class="bg-gray-100 p-4 rounded-lg shadow-md dark:bg-gray-700">
                    @csrf
                    <div class="mb-4">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 border-b border-gray-300 dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex justify-center gap-2">
                                        <button onclick="mostrarEditar('{{ $servicio->id }}', '{{ $servicio->nombre }}')"

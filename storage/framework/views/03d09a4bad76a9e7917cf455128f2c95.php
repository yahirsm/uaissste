                ...
                <div class="mt-4">
                    ...
                    <select id="rol" name="rol"
                        ...
                        <option value="Administrador"
                            <?php echo e(old('rol', $user->roles->pluck('name')->first() ?? '') == 'Administrador' ? 'selected' : ''); ?>>
                            Administrador
                        </option>
                        <option value="Jefe Abasto"
                            <?php echo e(old('rol', $user->roles->pluck('name')->first() ?? '') == 'Jefe Abasto' ? 'selected' : ''); ?>>
                            Jefe Abasto
                        </option>
                        <option value="Solicitante"
                            <?php echo e(old('rol', $user->roles->pluck('name')->first() ?? '') == 'Solicitante' ? 'selected' : ''); ?>>
                            Solicitante
                        </option>
                    </select>
                </div>

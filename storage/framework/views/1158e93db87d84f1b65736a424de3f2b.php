    ...
    <tbody>
        <?php $__currentLoopData = $partidas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partida): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700 border-b border-gray-300 dark:border-gray-700">
                <td class="px-4 py-3"><?php echo e($partida->clave); ?></td>
                <td class="px-4 py-3"><?php echo e($partida->nombre); ?></td>
                <td class="px-4 py-3 text-center">
                    <div class="flex justify-center gap-2">
                        <button onclick="mostrarEditarPartida('<?php echo e($partida->id); ?>', '<?php echo e($partida->clave); ?>', '<?php echo e($partida->nombre); ?>')"
...
<?php /**PATH C:\Users\Lenovo\Documents\GitHub\uaissste\resources\views/inventario/partidas-tabla.blade.php ENDPATH**/ ?>
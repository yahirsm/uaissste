        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'route' => route('distribucion.solicitud.index'),
                    'active' => request()->routeIs('distribucion.solicitud.*'),
                ],
                [
                    'name' => 'Pedidos',
                    'icon' => 'fa-solid fa-truck-fast',
                    'route' => route('distribucion.pedidos.index'),
                    'active' => request()->routeIs('distribucion.pedidos.*'),
                ],
            ],
        ],
    ];
                ...
                <?php elseif(isset($item['submenu'])): ?>
                    <li>
                        <button type="button"
                            ...
                            <svg class="w-3 h-3 transition-transform duration-200 <?php echo e($item['active'] ? 'rotate-180' : ''); ?>"
